1. `K = 10; N = 7'420'000` - процессы завершаются **корректно** потому что фактически здесь 
`N*K` = граница из первого эксперимента + возможно некоторые процессы успевают завершиться до начала других
2. `K = 30; N = 7'420'000` - некоторые процессы завершились аварийно. Здесь `N*K` примерно равно 19Gi, 
...
Такое `N` немного больше, чем `7'420'000 / 3 = 2'473'333`, это обусловлено тем, что некоторые процессы 
